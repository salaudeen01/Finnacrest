...
import { Grid, Card, Button, Typography, IconButton, Toolbar, AppBar, Dialog, MenuItem, TextField, Checkbox } from '@material-ui/core';
...
tabbed = (id) => {
  ...
  render(){
    ...
    const {tab,mTab, invest_data, categories, cards, add_card, showSaveCard, category, loading, singleInvestment, singleNews, isLoading, current_index, investment, showView, showInvest} = this.state
    return (
