      ...
      <div className="signup flex justify-center w-full h-full-screen" style={{
        ...
        backgroundAttachment: "fixed",
          ...
          <div className="p-4 flex w-full h-full-screen">
            <Grid container className="p-2" spacing={3} justify="center" alignItems="center">
              <Grid lg={11} md={11} sm={11} xs={11}>
                      ...
                      <Grid item lg={12} md={12} sm={12} xs={12}>
                        ...
                        <Grid item lg={12} md={12} sm={12} xs={12} className="mb-4">
                          <Button
                            ...
                            style={{background:"#224459", color:"#fff", width:"84%", padding:10, marginLeft:36, marginRight:36}}
                          >
                            Login
                          </Button>
                        ...
                        <Grid item lg={12} md={12} sm={12} xs={12} className=" mb-10" style={{textAlign:"center"}}>
                          <Button
                ...
                <Grid container className="p-2 mt-8" justify="center" alignItems="center">
                  
                    <Typography variant="h4" className="text-center text-white mt-25" style={{fontWeight:"bold", width:"10"}}>
                      Welcome to <br/>SESIS <br/> Co-OPERATIVE SOCIETY
                    </Typography>
